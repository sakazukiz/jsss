(function() {
    ...
    var te = {
        ...
        4986: function(_, m) {
            ...
            var y = {
                ...
                set: function(b, f, c) {
                    ...
                    var C = b + "=" + f + "; path=" + U;
                    P && (C += "; domain=" + P),
                    !c.ignoreTime && (C += "; expires=" + w.toUTCString()),
                    document.cookie = C
                },
                del: function(b, f) {
                    f === void 0 && (f = {}),
        ...
        9166: function(_, m, l) {
            ...
            var y = l(8807);
            function b(f, c) {
                return c === void 0 && (c = location.href),
                f instanceof Array || (f = [f]),
                c = c.replace(/[\r\n]/g, ""),
                (0,
                y.default)(f, function(w) {
                    c = c.replace(new RegExp("(?:&" + w + "=[^&]*)","g"), ""),
                    c = c.replace(new RegExp("(?:\\?" + w + "=[^&]*&?)","g"), "?")
                }),
                c
            }
        ...
        5926: function(_, m, l) {
            ...
            function f(c, w, P, U) {
                ...
                return O.addEventListener("load", F),
                O.addEventListener("error", A),
                O.charset = P || "utf-8",
                O.src = c,
                S.insertBefore(O, S.firstChild),
                U && (C = window.setTimeout(function() {
                    N(),
                    (0,
                    b.default)(w, null)
                }, U * 1e3)),
        ...
        9345: function(_, m, l) {
            ...
            function c(w) {
                ...
                return (0,
                f.default)(w) ? (0,
                b.default)(P[0]) ? w.call.apply(w, (0,
                y.__spreadArray)([null], P[0], !1)) : w.call.apply(w, (0,
                y.__spreadArray)([null], P, !1)) : null
            }
            m.default = c
        },
        7504: function(_, m, l) {
...
***************************************************************************** */
            var y = function(a, s) {
                ...
                || function(u, p) {
                    for (var k in p)
                        Object.prototype.hasOwnProperty.call(p, k) && (u[k] = p[k])
                }
                ,
                y(a, s)
            };
            function b(a, s) {
                ...
                a.prototype = s === null ? Object.create(s) : (u.prototype = s.prototype,
                new u)
            }
            var f = function() {
            ...
            function c(a, s) {
                var u = {};
                for (var p in a)
                    Object.prototype.hasOwnProperty.call(a, p) && s.indexOf(p) < 0 && (u[p] = a[p]);
                if (a != null && typeof Object.getOwnPropertySymbols == "function")
                    for (var k = 0, p = Object.getOwnPropertySymbols(a); k < p.length; k++)
                        s.indexOf(p[k]) < 0 && Object.prototype.propertyIsEnumerable.call(a, p[k]) && (u[p[k]] = a[p[k]]);
                return u
            }
            function w(a, s, u, p) {
                var k = arguments.length, v = k < 3 ? s : p === null ? p = Object.getOwnPropertyDescriptor(s, u) : p, x;
                if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
                    v = Reflect.decorate(a, s, u, p);
                else
                    for (var o = a.length - 1; o >= 0; o--)
                        (x = a[o]) && (v = (k < 3 ? x(v) : k > 3 ? x(s, u, v) : x(s, u)) || v);
                return k > 3 && v && Object.defineProperty(s, u, v),
                v
            }
            function P(a, s) {
                return function(u, p) {
            ...
            function O(a, s) {
                ...
                function e(t) {
                    ...
                    for (; u; )
                        try {
                            if (p = 1,
                            k && (v = t[0] & 2 ? k.return : t[0] ? k.throw || ((v = k.return) && v.call(k),
                            0) : k.next) && !(v = v.call(k, t[1])).done)
                                return v;
                            switch (k = 0,
                            v && (t = [t[0] & 2, v.value]),
                            t[0]) {
            ...
            function F(a, s) {
                for (var u in a)
                    u !== "default" && !Object.prototype.hasOwnProperty.call(s, u) && C(s, a, u)
            }
            function A(a) {
            ...
            function N(a, s) {
                ...
                if (!u)
                    return a;
                var p = u.call(a), k, v = [], x;
                try {
                    for (; (s === void 0 || s-- > 0) && !(k = p.next()).done; )
                        v.push(k.value)
                } catch (o) {
                    x = {
                        error: o
            ...
            function j() {
                for (var a = [], s = 0; s < arguments.length; s++)
                    a = a.concat(N(arguments[s]));
                return a
            }
            function $() {
                for (var a = 0, s = 0, u = arguments.length; s < u; s++)
                    a += arguments[s].length;
                for (var p = Array(a), k = 0, s = 0; s < u; s++)
                    for (var v = arguments[s], x = 0, o = v.length; x < o; x++,
                    k++)
                        p[k] = v[x];
                return p
            }
            function K(a, s, u) {
                if (u || arguments.length === 2)
                    for (var p = 0, k = s.length, v; p < k; p++)
                        (v || !(p in s)) && (v || (v = Array.prototype.slice.call(s, 0, p)),
                        v[p] = s[p]);
                return a.concat(v || Array.prototype.slice.call(s))
            }
            function Z(a) {
                return this instanceof Z ? (this.v = a,
                this) : new Z(a)
            }
            function z(a, s, u) {
                if (!Symbol.asyncIterator)
                    throw new TypeError("Symbol.asyncIterator is not defined.");
                var p = u.apply(a, s || []), k, v = [];
                return k = {},
                x("next"),
                x("throw"),
                x("return"),
            ...
            function ae(a) {
                if (!Symbol.asyncIterator)
                    throw new TypeError("Symbol.asyncIterator is not defined.");
                var s = a[Symbol.asyncIterator], u;
                return s ? s.call(a) : (a = typeof A == "function" ? A(a) : a[Symbol.iterator](),
                u = {},
                p("next"),
                p("throw"),
                p("return"),
            ...
            function se(a) {
                ...
                if (a != null)
                    for (var u in a)
                        u !== "default" && Object.prototype.hasOwnProperty.call(a, u) && C(s, a, u);
                return ne(s, a),
                s
            }
            function re(a) {
            ...
            function ue(a, s, u, p) {
                ...
                if (typeof s == "function" ? a !== s || !p : !s.has(a))
            ...
            function le(a, s, u, p, k) {
                ...
                if (typeof s == "function" ? a !== s || !k : !s.has(a))
                    throw new TypeError("Cannot write private member to an object whose class did not declare it");
                return p === "a" ? k.call(a, u) : k ? k.value = u : s.set(a, u),
                u
            }
        }
    }
    ...
    function L(_) {
        ...
        return te[_].call(l.exports, l, l.exports, L),
        l.exports
    }
    L.m = te,
    function() {
        ...
        L.t = function(l, y) {
            if (y & 1 && (l = this(l)),
            y & 8 || typeof l == "object" && l && (y & 4 && l.__esModule || y & 16 && typeof l.then == "function"))
                return l;
            var b = Object.create(null);
            L.r(b);
            var f = {};
            m = m || [null, _({}), _([]), _(_)];
            for (var c = y & 2 && l; typeof c == "object" && !~m.indexOf(c); c = _(c))
                Object.getOwnPropertyNames(c).forEach(function(w) {
                    f[w] = function() {
                        return l[w]
                    }
                });
    ...
    function() {
        L.d = function(_, m) {
            for (var l in m)
                L.o(m, l) && !L.o(_, l) && Object.defineProperty(_, l, {
                    enumerable: !0,
                    get: m[l]
                })
        }
    ...
    function() {
        ...
        L.l = function(l, y, b, f) {
            ...
            c.setAttribute("data-webpack", m + b),
            c.src = l),
            _[l] = [y];
            var O = function(F, A) {
            ...
            c.onerror = O.bind(null, c.onerror),
            c.onload = O.bind(null, c.onload),
            ...
            L.o(_, l) && _[l].forEach(function(b) {
                ...
                if (!(f.indexOf(c) >= 0)) {
                    ...
                    c.p)
                        return y.push(c.p);
                    var w = function(C) {
                        C || (C = new Error("Container missing")),
                ...
                var f = L.S[l]
                  ...
                  , U = function(O) {
                    ...
                    try {
                        ...
                        if (F.then)
                            return S.push(F.then(A, C));
                        var N = A(F);
                        if (N && N.then)
                            return S.push(N.catch(C))
                    } catch (j) {
                        C(j)
                    }
                }
...
(` + O + ": " + C + ")",
        ...
        var m = function(y, b) {
            ...
            for (y && y(b); S < f.length; S++)
                U = f[S],
                L.o(_, U) && _[U] && _[U][0](),
                _[f[S]] = 0
        }
          , l = self.webpackChunkweb = self.webpackChunkweb || [];
        l.forEach(m.bind(null, 0)),
        l.push = m.bind(null, l.push.bind(l))
    }();
    var fe = {};
    (function() {
        var _ = L(130)
        ...
        var P = function(o, e) {
            var t = window.report;
            if (t && typeof t.custom == "function")
                return t.custom(o, e);
            if (typeof t == "function")
                return t("midasbuy.custom." + o, e)
        };
        function U() {
            var o, e = (o = document.getElementById("xMidasToken")) === null || o === void 0 ? void 0 : o.value;
            if (!e)
                return P("xmidas.no.token");
            try {
                var t = c(function() {
        ...
        function S(o, e) {
            var t = e === "goServer" ? JSON.stringify(o) : JSON.stringify((0,
            y.Z)(o, function(d) {
        ...
        function j(o) {
            ...
            n === "GET" ? (i = (0,
            _.Z)(d, i),
            E.open(n, i, !0)) : (E.open(n, i, !0),
            T === "json" ? E.setRequestHeader("Content-Type", "application/json") : E.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"));
            var R = A();
            R && (I = Object.assign({}, I, R)),
            Object.entries(I).forEach(function(D) {
                var B = N(D, 2)
                  , G = B[0]
                  , H = B[1];
            ...
            return new Promise(function(D, B) {
                ...
                var H;
                n === "POST" && (H = T === "json" ? JSON.stringify(d) : (0,
                O.default)(d)),
                E.send(H)
            }
            )
        ...
        var $ = function(o, e) {
          ...
          , ne = L(4986);
        function se() {
            var o, e, t = ne.Z.get("UUID") || ((o = window.__Report_INFO) === null || o === void 0 ? void 0 : o.tid) || "", n = (e = navigator.platform) === null || e === void 0 ? void 0 : e.toLowerCase(), i = !!window.navigator.cookieEnabled, r = navigator.userAgent, d = ne.Z.get("device_id") || "", h = window.fingerprint || "", I = [t, n, i, "", r, d, window.currentLang || "en", h];
            return I.map(function(g) {
                return oe(g)
            }).join(",")
        }
        function re(o) {
            return o.browser_info = se(),
            Promise.resolve(o)
        }
        var ue = function() {
            function o() {}
          ...
          , u = function(o, e) {
            ...
            function I(g) {
                ...
                for (; t; )
                    try {
                        if (n = 1,
                        i && (r = g[0] & 2 ? i.return : g[0] ? i.throw || ((r = i.return) && r.call(i),
                        0) : i.next) && !(r = r.call(i, g[1])).done)
                            return r;
                        switch (i = 0,
                        r && (g = [g[0] & 2, r.value]),
                        g[0]) {
                        ...
                        default:
                            if (r = t.trys,
                            !(r = r.length > 0 && r[r.length - 1]) && (g[0] === 6 || g[0] === 2)) {
                                t = 0;
                                continue
                            }
          ...
          , v = function() {
            ...
            o.prototype.handleCallback = function(e) {
                ...
                r.indexOf(n) !== -1 && (h = this.callback.loginSuccessCallback),
                d.indexOf(n) !== -1 && (h = this.callback.loginFailCallback),
                h && h(a(a({}, e), {
                    user: i,
            ...
            o.prototype.handleBindOpenidParams = function() {
                var e = (0,
                m.Z)("appid");
                !this.params.pageConfig.appid && e && (this.params.pageConfig.appid = e),
                this.params.lang && (this.params.pageConfig.lang = this.params.lang)
            }
            ,
            o.prototype.handleInitParams = function(e) {
                !e || (this.initParams = a({}, e),
                this.params = a(a(a({}, this.params), e), {
            ...
            o.prototype.handleLoginParams = function(e) {
                ...
                e.preload === !0 && delete e.preload,
                e.hash || (e.hash = "#login");
                var n = (e == null ? void 0 : e.pageConfig) || {}
                  , i = n.needReloadIframe
                  , r = n.appid;
                this.needReloadIframe = i || !!r && ((t = this.params.pageConfig) === null || t === void 0 ? void 0 : t.appid) !== r,
                this.params = a(a(a({}, this.params), e), {
            ...
            o.prototype.toggleLockBackground = function(e) {
                ...
                if (!!((t = document.body) === null || t === void 0 ? void 0 : t.style)) {
                    var h = new le
                      ...
                      , g = I > 0;
                    if (e === "lock")
                        this.preOverflow = ((i = (n = document.body) === null || n === void 0 ? void 0 : n.style) === null || i === void 0 ? void 0 : i.overflow) || "",
                        this.prePosition = ((d = (r = document.body) === null || r === void 0 ? void 0 : r.style) === null || d === void 0 ? void 0 : d.position) || "",
                        this.prePaddingRight = document.body.style.paddingRight || "",
                        this.preTop = document.body.style.top || "",
                        this.preWidth = document.body.style.width || "",
                        g && (document.body.style.paddingRight = (this.prePaddingRight ? parseInt(this.prePaddingRight, 10) : 0) + I + "px"),
                        k && (document.body.style.position = "fixed",
                        document.body.style.width = "100%"),
                        document.body.style.top = "-" + window.scrollY + "px",
                        document.body.style.overflow = "hidden";
                    else {
                        var T = document.body.style.top;
                        k && (document.body.style.position = this.prePosition,
                        ...
                        window.scrollTo(0, parseInt(T || "0", 10) * -1),
            ...
            o.prototype.toggleIframe = function(e) {
                ...
                if (!!n) {
                    var i = function() {
                        var r;
                        t.params.pageConfig.report = e === "visible",
                        e === "visible" && (n.src = "" + n.src.replace(/#.+/, t.params.hash)),
                        (r = n.contentWindow) === null || r === void 0 || r.postMessage(JSON.stringify({
                            action: "changePageConfig",
                            pageConfig: t.params.pageConfig
                        }), "*"),
                        n.style.visibility = e,
                        n.style.left = e === "visible" ? 0 : "-5000px",
                        t.toggleLockBackground(e === "visible" ? "lock" : "unlock")
                    };
            ...
            o.prototype.waitForXMidas = function() {
                ...
                return new Promise(function(t, n) {
                      ...
                      , r = setInterval(function() {
                        return s(e, void 0, void 0, function() {
                            return u(this, function(d) {
                                return "xMidas"in window && (clearInterval(r),
                                i = !0,
                                U(),
                                t()),
                                [2]
                    ...
                    setTimeout(function() {
                        i || (console.error("window.xMidas function is not loaded"),
                        clearInterval(r),
                        n())
                    }, 5e3)
                }
            ...
            o.prototype.getDomTree = function() {
                var e, t = {
                    ...
                    overflow: "hidden",
                    border: "medium none"
                }, n = this.params.pageConfig || {}, i = this.params.host || location.host, r = (0,
                _.Z)(n, "https://" + i + "/apps/login/home/" + (((e = this.params.country) === null || e === void 0 ? void 0 : e.toLowerCase()) || "ot"));
                ...
                window.addEventListener("message", function(t) {
                    ...
                    if (!(!d.test(n) && location.origin !== n || !r)) {
                        ...
                        case "iframeLoad":
                            ...
                            (!e.params.preload && !e.params.hasLoaded || e.needReloadIframe) && e.toggleIframe("visible"),
            ...
            o.prototype.handleFail = function(e) {
                ...
                ["confirmLinkFail", "otherFail", "gameLinkFail"].includes(t) && this.hideLoginIframe()
            }
            ,
            o.prototype.handleSuccess = function(e, t) {
                var n = this;
                t === void 0 && (t = "login"),
                this.loginInfoRequest().then(function(i) {
                    var r = i.user;
                    n.handleLoginInfo(i),
                    n.handleCallback(a(a({}, e), {
                        user: r
                    })),
                    n.hideLoginIframe()
                }).catch(function(i) {
                ...
                return s(this, void 0, void 0, function() {
                    ...
                    return u(this, function(M) {
                        ...
                        case 0:
                            ...
                            I = r.loginKey,
                            d && (i.versions = d),
                            h ? (g = Math.floor(Date.now() / 1e3),
                            i.Csrftokentime = g,
                            [4, L.e(153).then(L.t.bind(L, 2153, 23))]) : [3, 2];
                        case 1:
                            T = M.sent(),
                            E = "" + JSON.stringify(e) + I + g,
                            R = (n = (t = T == null ? void 0 : T.default) === null || t === void 0 ? void 0 : t.call(T, E)) === null || n === void 0 ? void 0 : n.toString(),
                            i.Csrftokenv2 = R,
                            M.label = 2;
                        case 2:
                            return [2, i]
            ...
            o.prototype.handleLoginInfo = function(e) {
                var t = e || {}
                  ...
                  , d = t.csrftoken;
                this.params.user = n,
                this.params.goServerUrl = this.params.goServerUrl || i,
                this.csrftoken = d || "",
                this.loginConfig = r
            }
            ,
            ...
            o.prototype.login = function(e) {
                var t = this;
                this.handleLoginParams(e),
                this.loginInfoRequest().then(function(n) {
                    var i, r, d = n.user, h = n.loginConfig;
                    if (t.handleLoginInfo(n),
                    t.params.pageConfig.appid || (t.params.pageConfig.appid = n.gameAppid),
                    !d)
                        return t.showLoginIframe();
                    if (!d.currentBindUser && t.params.pageConfig.appid) {
                        ...
                        if (g)
                            return t.params.hash = "#bind-openid",
                            t.showLoginIframe()
                    }
                    if (t.params.hash === "#bind-openid")
                        return t.showLoginIframe();
                    var T = t.params.hash
                ...
                return s(this, void 0, void 0, function() {
                    ...
                    return u(this, function(i) {
                        ...
                        case 1:
                            ...
                            i.label = 2;
                        case 2:
                            return n = this.params.goServerUrl + "/logout",
                            [2, j({
                                url: n,
                                method: "POST",
                                timeout: 5,
            ...
            o.prototype.init = function(e) {
                this.params.hasInit || (this.params.hasInit = !0,
            ...
            o.prototype.thirdPartyLogin = function(e) {
                var t, n = e.thirdPartyType, i = n === void 0 ? "facebook" : n, r = e.loginCallback, d = e.country, h = d === void 0 ? "ot" : d, I = e.pageConfig, g = I === void 0 ? {} : I, T = function() {
                    location.reload()
                };
                if (i === "lipass")
                    return this.login({
            ...
            o.prototype.signUp = function() {
                ...
                (e = t == null ? void 0 : t.contentWindow) === null || e === void 0 || e.switchModule("sign-up"),
                this.login()
            }
            ,
                ...
                return s(this, void 0, void 0, function() {
                    ...
                    return u(this, function(Y) {
                        ...
                        case 0:
                            ...
                            this.params.goServerUrl ? [3, 2] : [4, this.loginInfoRequest()];
                        case 1:
                            if (t = Y.sent(),
                        ...
                        case 3:
                            ...
                            D = M.ret,
                            B = M.data,
                            D !== 0 || (B == null ? void 0 : B.action) === "login_fail_had_bind")
                                return [2, {
                                    ret: 1,
                            ...
                            q = G.game_nike_name,
                            J = G.player_id,
                            X = (B == null ? void 0 : B.bind_login_account) || {},
                            Q = X.platform,
                            ee = X.nikename,
                            V = {
                                authType: "gameTicket",
                ...
                return s(this, void 0, void 0, function() {
                    ...
                    return u(this, function(W) {
                        ...
                        case 2:
                            ...
                            T = this.params.goServerUrl + "/login",
                            [4, re(g)]);
                        case 3:
                            return E = W.sent(),
                            [4, this.getGoHeaders(E)];
                        case 4:
                            return R = W.sent(),
                            [4, j({
                                url: T,
                        ...
                        case 5:
                            return M = W.sent(),
                            (M == null ? void 0 : M.ret) === 0 ? (D = (M == null ? void 0 : M.data) || {},
                            B = D.Uid,
                            G = D.Platform,
                            H = D.PlatformOpenId,
                            q = D.UserName,
                ...
                return s(this, void 0, void 0, function() {
                    ...
                    return u(this, function(q) {
                        ...
                        case 2:
                            ...
                            T = this.params.goServerUrl + "/lipLogin",
                            [4, re(g)]) : [2, {
                                ret: 1,
                ...
                return s(this, void 0, void 0, function() {
                    ...
                    return u(this, function(I) {
                        ...
                        case 2:
                            return i = (e || {}).platform,
                            r = i === void 0 ? "" : i,
                            r ? [4, $(this.params.goServerUrl, e)] : [2, {
                                ret: 1,
                ...
                return s(this, void 0, void 0, function() {
                    ...
                    return u(this, function(h) {
                        ...
                        case 1:
                            ...
                            h.label = 2;
                        case 2:
                            return i = (e || {}).passkey_id,
                            r = i === void 0 ? "" : i,
                            r ? [2, z(this.params.goServerUrl, e)] : [2, {
                                ret: 1,
